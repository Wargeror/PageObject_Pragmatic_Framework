...
public class WebApp {
    ...
    private Product4$Page product4$Page;
    ...
    public Product4$Page product4$Page() {
        if (product4$Page == null) {
            product4$Page = new Product4$Page(driver, wait, this);
        }
        return product4$Page;
    }
