...
public class BasePage {
    ...
    public static void waitForFullPageLoad(WebDriver driver, int timeoutSeconds) {
        ...
        if (Boolean.TRUE.equals(js.executeScript("return typeof jQuery != 'undefined'"))) {
        ...
        wait.until(d -> (Boolean) js.executeScript(
                "var entries = performance.getEntriesByType('resource');" +
                        ...
                        "return (performance.now() - (lastEntry.startTime + lastEntry.duration)) > 500;"
        ));
    }
