...
public class Product4SalePage extends BasePage {
    ...
    public Product4SalePage(WebDriver driver, WebDriverWait wait, WebApp webApp){
    ...
    public Product4SalePage clickAlertX(){
        clickWebElement(alertX);
        return this;
    }

    public Product4SalePage clickCart(){
    ...
    public Product4SalePage clickAddToCart(){
